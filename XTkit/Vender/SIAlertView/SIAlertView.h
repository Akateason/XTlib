...
typedef NS_ENUM(NSInteger, SIAlertPositionStyle) {
    SIAlertViewPositionMiddle = 0 ,
    SIALertViewPositionBottom
} ;
...
@property (nonatomic, assign) SIAlertPositionStyle positionStyle ; // default is middle ; @ADD BY TEASON
